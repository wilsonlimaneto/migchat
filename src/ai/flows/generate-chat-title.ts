...
/**
 * @fileOverview A flow to generate a title for a chat based on the chat history.
 *
...
const GenerateChatTitleInputSchema = z.object({
  chatHistory: z
    .string()
    .describe('The complete chat history to use to generate a relevant title.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert at summarizing chats and creating titles.

  Based on the following chat history, generate a concise and relevant title for the chat session.
