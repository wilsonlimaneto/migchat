...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following chat history in a concise paragraph.  Focus on the key topics discussed and the overall sentiment. Chat History: {{{chatHistory}}}`,
});
